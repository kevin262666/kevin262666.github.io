...
<template>
  ...
  <section class="block">
    <h2 class="tit-type1 sellType" title="設定停利觸發與下單條件">
      設定<b>停利</b>觸發與下單條件
    </h2>
  ...
  <section class="block">
    <h2 class="tit-type1 sellType" title="設定出清時間與下單條件">
      設定<b>出清時間</b>與下單條件
    </h2>
    <div class="setConditions sellType">
      <el-row :gutter="store.state.setConditionsGutter">
          ...
          <div class="setConditions-item alignTop">
            <div class="setConditions-item-input">
              <el-row :gutter="store.state.setConditionsItemInputGutter">
                ...
                <el-col :span="14">
                  <el-input-number v-model="num7" :min="1" :step="1" placeholder="請輸入張數" />
                </el-col>
              </el-row>
            </div>
          </div>
          ...
          <div class="setConditions-item alignTop">
            <div class="setConditions-item-input">
              <el-row :gutter="store.state.setConditionsItemInputGutter">
                ...
                <el-col :span="14">
                  <el-input-number v-model="num8" :min="1" placeholder="請輸入價格" />
                </el-col>
              </el-row>
            </div>
          </div>
      ...
      <el-alert type="info" :closable="false" class="resetAlert">
        <template #title>
          ...
          <div class="resetAlert-content">
            在<b class="text-black">2022/04/11</b>前，當<b class="text-black">中鋼2002成交價≥30</b>，即以<b class="text-black">限價35元</b>停利委託賣出<b class="text-black">5張</b>；<b class="text-black">或</b> 當<b class="text-black">成交價≤28元</b>，即以<b class="text-black">市價</b>停損委託買進<b class="text-black">5張</b>，若當停利、停損皆未觸發，則<b class="text-black">將於2022/04/11 上午08:27</b>，以<b class="text-black">市價</b>委託買進<b class="text-black">5張</b>。
          </div>
        </template>
      </el-alert>
    </div>
