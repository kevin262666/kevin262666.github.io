!function(a) {
    ...
    a.material = {
        options: {
            ...
            arrive: !0,
            autofill: !1,
			withRipples: [".ripplesBtn","nav a", ".topBtn a", ".linkListArrow-type2-arrow", ".linkListArrow-type1-arrow", ".page-arrow a", ".page-link a", ".related-link a", ".tabsArea-tab a", ".noInfo-related-link a"].join(","),
