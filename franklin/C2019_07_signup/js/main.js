...
var content = new Vue({
    ...
    methods: {
        ...
        useJq() {
            //-------------------------------------signature
            console.log('%cMade by Captain%c2019/06',
            ...
            //-------------------------------------步驟
            $('.openAccountWay-item-top').on('click', function(){
                var n = $(this).parents('.openAccountWay-item').index();
                $(this).parents('.openAccountWay-item').toggleClass('active').siblings('.openAccountWay-item').removeClass('active');
                $('.openAccountStep').eq(n).slideToggle().siblings('.openAccountStep').hide();
            });
            $('.openAccountWay-item-openStepBtn').on('click', function () {
                var n = $(this).parents('.openAccountWay-item').index();
                $(this).parents('.openAccountWay-item').toggleClass('active').siblings('.openAccountWay-item').removeClass('active');
                $('.openAccountStep').eq(n).slideToggle().siblings('.openAccountStep').hide();
            });
